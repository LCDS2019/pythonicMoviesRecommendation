...
if opcao == "Cadastro de Usuário":
    ...
    for f in onto.Titulo.instances():
        ...
        match_genero = not generos_usuario or any(g.nome_genero in generos_usuario for g in f.tem_genero)
        match_ator = not ator_usuario or ator_usuario in f.tem_ator
        match_diretor = not diretor_usuario or diretor_usuario in f.tem_diretor

        if match_genero and match_ator and match_diretor:
